...
public class ManualController {
        ...
        public String showMyManuals(
                        ...
                        @PageableDefault(size = 10) Pageable pageable) {
                log.info("start");
                Page<Manual> manuals = query.findMyCreatedManualsPage(principal, pageable);
                ManualIndexDto listDto = query.showIndex(principal, manuals, condition);
                model.addAttribute("listDto", listDto);
                return "index";
        }
        ...
        public String showCreatedPendingManuals(
                        ...
                        @PageableDefault(size = 10) Pageable pageable) {
                log.info("start");
                Page<Manual> manuals = query.findMyPendingManuals(principal, pageable);
                ManualIndexDto listDto = query.showIndex(principal, manuals, condition);
                model.addAttribute("listDto", listDto);
                return "index";
        }
        ...
        public String showRecentWeeklyManuals(
                        ...
                        @PageableDefault(size = 10) Pageable pageable) {
                log.info("start");
                Page<Manual> manuals = query.findRecentlyUpdatedManuals(pageable);
                ManualIndexDto listDto = query.showIndex(principal, manuals, condition);
                model.addAttribute("listDto", listDto);
                return "index";
        }
